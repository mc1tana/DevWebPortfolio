...
const describeProject=[
    ...
    {name:"rateBook", title:"back end (logique connection, crud)",frame:"Projet réalisé dans le cadre de ma formation OpenClassrooms de développeur front-end.", mission:"Réalisation du back d'un site de notation et publication de livre" , technique:"Site mobile first responsive, aucune erreur ni alerte au validateur W3C HTML et CSS, site compatible avec les dernières versions de Chrome et Firefox.", techno:["Html","Css","react","node-JS"], link:"https://mc1tana.github.io/bookRate", image:"./assets/images/ordiSophie.png"}
]
